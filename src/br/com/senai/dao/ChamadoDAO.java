...
public class ChamadoDAO {
	...
	/*
	 * private String pegarDataAtual() { DateFormat dateFormat = new
	...
	public List<Chamado> listar() {
		try {
			...
			PreparedStatement stmt = this.conexao.prepareStatement("select * from chamado order by id desc");
	...
	public List<Funcionario> listarTecnicos() {
		try {
			...
			PreparedStatement stmt = this.conexao.prepareStatement("select * from funcionario where tipo='Tecnico' ");
			ResultSet rs = stmt.executeQuery();
