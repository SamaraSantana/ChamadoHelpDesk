...
<body>
	...
	<div id="topo_form">
		...
		<div id="formulario_funcionario">
			...
			<form id="formulario"  name="formulario" action="alterarTecnico" method="post">
			<p>
				...
				<p>
				<label class="login" for="login">Login:</label> <input type="hidden" name="id" value="${funcionario.id }" /> 
